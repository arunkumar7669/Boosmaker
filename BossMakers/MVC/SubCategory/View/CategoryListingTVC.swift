...
class CategoryListingTVC: UITableViewCell {
      ...
      extension CategoryListingTVC: UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
