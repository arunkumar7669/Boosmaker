...
extension UIView {
    ...
    func addDashedBorder(width: CGFloat? = nil, height: CGFloat? = nil, lineWidth: CGFloat = 2, lineDashPattern:[NSNumber]? = [6,3], strokeColor: UIColor = Constants.appThemeColor, fillColor: UIColor = UIColor.clear) {
