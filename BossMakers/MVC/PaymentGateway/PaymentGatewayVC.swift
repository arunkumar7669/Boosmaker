...
//  BossMakers
//
//  Created by Abhishek  Tomar on 03/07/20.
...
class PaymentGatewayVC: UIViewController {
   ...
   private var razorpayObj : RazorpayCheckout?
        let defaultHeight : CGFloat = 40
        let defaultWidth : CGFloat = 120
        
        let razorpayKey = "rzp_test_myy6gD2AQmkRUF" // Sign up for a Razorpay Account(https://dashboard.razorpay.com/#/access/signin) and generate the API Keys(https://razorpay.com/docs/payment-gateway/dashboard-guide/settings/#api-keys/) from the Razorpay Dashboard.
    ...
    extension PaymentGatewayVC : RazorpayPaymentCompletionProtocol {
    ...
    extension PaymentGatewayVC: RazorpayPaymentCompletionProtocolWithData {
